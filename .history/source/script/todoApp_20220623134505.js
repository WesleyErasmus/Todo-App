  ...
  tasksForm.addEventListener("submit", (e) => {
    ...
    const task = {
     ...
     if( title.value === "" ) {
      ...
      document.querySelector("#title").style.backgroundColor = "red; borderBottomLeftRadius = 0.5rem; borderBottomRightRadius = 0.5rem;" 
      return false;
   } else {
...
function printTasksToDOM() {
  ...
  tasks.forEach((task) => {
    ...
    function backgroundChange() {
      if(personalBtn.innerHTML === "Personal")
        button.innerHTML = "Work";
      else
        button.innerHTML = "Personal";
    }

      personalBtn.addEventListener("click", (e) => {
        for (i = 0 ; i < categoryBg.length ; ++i)
        // containers[i].classList.toggle('changeClass');
        containers[i].style.backgroundColor = "#2093ff2b"
