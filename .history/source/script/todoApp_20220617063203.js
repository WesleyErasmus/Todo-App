window.addEventListener('load', () => {
    ...
    tasksForm.addEventListener("submit", e => {
        ...
        // the name ="title" value from the id="content" input field
        // the name ="description" value from the id="description" input field
        // the name ="category" value from the labels withing the class="category-selectors" input fields
        const task = {
