...
const dateSortButton = document.querySelector("#sort-by-date");
let desc = false;
dateSortButton.addEventListener('click', () => {
let tasks = sort_array_by(taskList, 'title', desc);
displayList(tasks);

desc = !desc;
})
// sort_date_btn.addEventListener('click', () => {
//     let tasks = sort_array_by(list_items, 'title', desc);
//     displayList(tasks);
    
//     desc = !desc;
// })

function sort_array_by (tasks, sort, desc) {
...
function displayList (tasks = []) {
    ...
    //     tasks.sort();
    //     document.getElementById("task-list").innerHTML = tasks + "" + "<br>";
    //   }
