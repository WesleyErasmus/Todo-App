  ...
  tasksForm.addEventListener("submit", (e) => {
    ...
    const task = {
     ...
     if( title.value === "" ) {
      ...
      document.querySelector(".error-validation-message").style.color="#EE4B2B";
   ...
   if( date.value === "" ) {
    ...
    document.querySelector(".calendar-tooltip").style.color ="#EE4B2B";
    document.querySelector(".fa-calendar-days").style.color ="#EE4B2B";
    return false;
 } else {
