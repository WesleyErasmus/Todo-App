...
// var elephant = document.getElementById("output");
// let fileUpload = localStorage.getItem('file') || '';
//   fileUpload = image.value;
//   image.src = URL.createObjectURL(event.target.files[0]);
// Take action when the image has loaded
var elephant = document.getElementById("output");

elephant.addEventListener("load", function (event) {
...
//   fileUpload = image.value;
//   image.src = URL.createObjectURL(event.target.files[0]);
//    localStorage.setItem('file', event.target.value[0]);
// };
